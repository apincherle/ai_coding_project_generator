...
public class CustomerController {
  ...
  @GetMapping("/{id}") public Customer get(@PathVariable UUID id) { return service.get(id); }
  ...
  @PutMapping("/{id}") public Customer update(@PathVariable UUID id, @Valid @RequestBody CustomerRequest request) { return service.update(id, request); }
